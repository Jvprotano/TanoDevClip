...
namespace TanoDevClip.DevTools
{
    public static class LoremGenerator
    {
        ...
        public static DevToolResult GenerateByCharactersResult(int length = 460)
        {
            return DevToolResult.Success(GenerateByCharacters(length));
        }

        public static DevToolResult GenerateByWordsResult(int wordCount = 46)
        {
            return DevToolResult.Success(GenerateByWords(wordCount));
        }
